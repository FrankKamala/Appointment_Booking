...
public class MainActivity extends AppCompatActivity
    ...
    private CardView callCard, medCard, payCard, bookCard;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bookCard = findViewById(R.id.appointment_card);
...
////set
        callCard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent k = new Intent(getApplicationContext(),Contact.class);
                startActivity(k);
            }
        });
        medCard.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent k = new Intent(getApplicationContext(),Meds.class);
                startActivity(k);
            }
        });
        payCard.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent k = new Intent(getApplicationContext(),Pay.class);
                startActivity(k);
            }
        });
        bookCard.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent k = new Intent(getApplicationContext(),Book.class);
                startActivity(k);
            }
        });
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Snackbar.make(view, "Waiting for Kamala to finish up", Snackbar.LENGTH_LONG)
